...
import FPSControls from "@/app/shared/components/3d/FPSControls";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Html position={[0, -0.5, 3]} center distanceFactor={8}>
          <div data-testid="room-selector" className="bg-black/80 backdrop-blur-sm rounded-lg p-4 text-center">
        ...
        {!session && !authModal.isOpen && (
          <Html position={[25, 8, -15]} center distanceFactor={12}>
            <div
