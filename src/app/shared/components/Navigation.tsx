...
const NAV_LINKS = [
  ...
  { href: "/tickets/success", label: "Tickets" },
...
export function Navigation() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-theme-secondary bg-[#05070d]/90 backdrop-blur-xl">
        <div className="app-shell h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 text-xl font-bold tracking-tight text-theme-primary">
        ...
        >
          <div className="app-shell py-6 space-y-4">
            ...
            <div className="pt-2">{/*<UserStatus onOpenAuth={mode => setAuthMode(mode)} />*/}</div>
          </div>
        </div>
      </nav>
