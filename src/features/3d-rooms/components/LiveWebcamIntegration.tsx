  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
            ...
            <video
              ...
              onError={e => {
                console.error("❌ Video error:", {
                  ...
                  srcObject: !!(e.target as HTMLVideoElement)?.srcObject,
      ...
      <div className="mt-2 bg-red-900/90 border border-red-500 rounded p-2 text-xs font-mono">
        ...
        <div className="text-white">MediaDevices: {navigator.mediaDevices ? "✅ OK" : "❌ FEHLT"}</div>
        <div className="text-white">
          getUserMedia:{" "}
          {navigator.mediaDevices && typeof navigator.mediaDevices.getUserMedia === "function" ? "✅ OK" : "❌ FEHLT"}
        </div>
        <div className="text-white">
          Sicher:{" "}
